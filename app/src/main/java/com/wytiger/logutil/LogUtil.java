...
//        }
    ...
    private static String createLog(String log) {
        //通过线程栈帧元素获取相应信息
//        Log.i("LogUtil","sElements[0] = " + Thread.currentThread().getStackTrace()[0]);//VMStack
//        Log.i("LogUtil","sElements[1] = " + Thread.currentThread().getStackTrace()[1]);//Thread
//        Log.i("LogUtil","sElements[2] = " + Thread.currentThread().getStackTrace()[2]);//当前方法帧元素
//        Log.i("LogUtil","sElements[3] = " + Thread.currentThread().getStackTrace()[3]);//LogUtil.x栈元素
//        Log.i("LogUtil","sElements[4] = " + Thread.currentThread().getStackTrace()[4]);//LogUtil.x上层调用者
